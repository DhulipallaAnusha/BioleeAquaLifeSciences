...
(window._gsQueue || (window._gsQueue = [])).push(function() {
    ...
    window._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function(t, e) {
        ...
        , $ = a.getStyle = function(t, e, i, s, r) {
            var n;
            return U || "opacity" !== e ? (!s && t.style[e] ? n = t.style[e] : (i = i || G(t, null)) ? (t = i.getPropertyValue(e.replace(P, "-$1").toLowerCase()),
        ...
        , Z = function(t, e, i, s, r) {
            ...
            return l && (i = -i),
            "%" === s && -1 !== e.indexOf("border") ? n = i / 100 * (a ? t.clientWidth : t.clientHeight) : (h.cssText = "border:0 solid red;position:" + $(t, "position") + ";line-height:0;",
          ...
          , be = function(t, e, i, s) {
            ...
            if (16 === n.length) {
                ...
                !i || s || null == v.rotationX) {
                    ...
                    v.scaleZ = (0 | Math.sqrt(Z * Z + R * R) * w + .5) / w,
                    v.skewX = 0,
        ...
        de("borderRadius", {
            ...
            parser: function(t, e, i, n, a) {
                ...
                h = 0; b.length > h; h++)
                    ...
                    g = p.substr((f + "").length)),
                    "" === g && (g = s[i] || v),
                    g !== v && (T = Z(t, "borderLeft", c, v),
                    w = Z(t, "borderTop", c, v),
                    "%" === g ? (u = 100 * (T / m) + "%",
                    _ = 100 * (w / d) + "%") : "em" === g ? (x = Z(t, "borderLeft", 1, "em"),
                    u = T / x + "em",
                    _ = w / x + "em") : (u = T + "px",
                    _ = w + "px"),
        ...
        de("backgroundPosition", {
            ...
            parser: function(t, e, i, s, n, a) {
                ...
                if (-1 !== d.indexOf("%") != (-1 !== g.indexOf("%")) && (p = $(t, "backgroundImage").replace(k, ""),
                p && "none" !== p)) {
                    for (o = d.split(" "),
                    h = g.split(" "),
        ...
        var Re = function(t) {
            ...
            e = !$(this.data, "filter")) : (i.filter = s.replace(x, ""),
            e = !0)),
        ...
        h.parse = function(t, e, i, n) {
            ...
            for (a in e)
                c = e[a],
                h = o[a],
                h ? i = h.parse(t, c, a, this, i, n, e) : (p = $(t, a, r) + "",
                d = "string" == typeof c,
                ...
                f !== m && "" !== m && (u || 0 === u) && (_ || 0 === _) && (_ = Z(t, a, _, f),
                "%" === m ? (_ /= Z(t, a, 100, "%") / 100,
                e.strictUnits !== !0 && (p = _ + "%")) : "em" === m ? _ /= Z(t, a, 1, "em") : (u = Z(t, a, u, m),
                m = "px"),
                g && (u || 0 === u) && (c = u + _ + m)),
                g && (u += _),
