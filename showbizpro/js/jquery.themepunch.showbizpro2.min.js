...
(function(e, t) {
    ...
    function s(t, n) {
        ...
        t.find(".reveal_opener").each(function() {
            var r = e(this);
            r.click(function() {
                if (r.parent().hasClass("reveal_container"))
                    var i = r.parent();
                else
                    var i = r.parent().find(".reveal_container");
                if (i.hasClass("revactive")) {
                    ...
                    setTimeout(function() {
                        if (t.data("coo") == "on")
                            i.closest("ul").find(".reveal_opener").each(function(t) {
                                if (e(this).hasClass("revactive"))
                                    e(this).click()
                            });
                        ...
                        i.find(".sb-vimeo-markup, .sb-yt-markup").each(function(n) {
                            var r = e(this);
                            if (r.hasClass("sb-vimeo-markup"))
                                var i = t.data("vimeomarkup");
                            else
                                var i = t.data("ytmarkup");
    ...
    function u(t, n, r) {
        ...
        if (t.find(".tofullwidth.revactive .heightadjuster").length > 0) {
            ...
            var u = o;
            if (u <= 0)
                u = t.find("ul:first-child li").length;
    ...
    function a(t, n, r) {
        ...
        if (t.find(".tofullwidth.revactive .heightadjuster").length > 0) {
            var o = t.find(".tofullwidth.revactive").data("indexli");
            var u = o + 2;
            if (u > t.find("ul:first-child li").length)
                u = 1;
            t.find(".tofullwidth.revactive").addClass("sb-removemesoon");
            setTimeout(function() {
                t.find(".tofullwidth.revactive.sb-removemesoon .reveal_opener").click();
    ...
    function f(n) {
        ...
        n.find("img").each(function() {
            ...
            if (i != t && i.length > 3 && !n.hasClass("waitingforload") && r < 4) {
                ...
                var s = n;
                if (s.data("wan") == t)
                    s.data("wan", s.css("-webkit-transition"));
                if (s.data("moan") == t)
                    s.data("moan", s.css("-moz-animation-transition"));
                if (s.data("man") == t)
                    s.data("man", s.css("-ms-animation-transition"));
                if (s.data("ani") == t)
                    s.data("ani", s.css("transition"));
                ...
                if (n.hasClass("waitingforload"))
                    r++;
                if (i != t && i.length > 3) {
                    if (n.data("lazyloadheight") != t)
                        n.css({
    ...
    function c(t, n, r) {
        ...
        if (Math.abs(m) >= f * l) {
            ...
            if (t.hasClass("sb-attheend")) {
                ...
                if (r && i.data("rewindfromend") == "on")
                    t.addClass("sb-attheend")
            }
        } else {
            t.removeClass("sb-attheend");
            try {
    ...
    function h(n, r, i) {
        ...
        var y = 0;
        if (r.data("eoffset") != t)
            y = r.data("eoffset") * (d - 1);
        var b = 0;
        if (r.data("croffset") != t)
            b = r.data("croffset");
        step = (f - (d - 1) * g) / d;
        step = Math.round(step - y);
        var w = false;
        u.find(">li").each(function() {
            if (e(this).width() != step)
                w = true;
            e(this).width(step)
        });
        u.css({
        ...
        var x = 0;
        if (r.data("hboffset") != t)
            x = r.data("hboffset");
        setTimeout(function() {
            var t = 0;
            u.find("li").each(function() {
                if (e(this).outerHeight(true) > t)
    ...
    e.fn.extend({
        showbizpro: function(n) {
            ...
            return this.each(function() {
                ...
                if (g.data("left") == t)
                    g.data("left", "sb_left_" + S);
                if (g.data("right") == t)
                    g.data("right", "sb_right_" + S);
                if (g.data("play") == t)
                    g.data("play", "sb_play_" + S);
                var x = e(g.data("left"));
                var T = e(g.data("right"));
                var N = e(g.data("play"));
                if (x == t || x.length == 0)
                    e("body").append('<a style="display:none" id="' + g.data("left") + '" class="sb-navigation-left"><i class="sb-icon-left-open"></i></a>');
                if (T == t || T.length == 0)
                    e("body").append('<a style="display:none" id="' + g.data("right") + '" class="sb-navigation-right"><i class="sb-icon-right-open"></i></a>');
                if (N == t || N.length == 0)
                    e("body").append('<a style="display:none" id="' + g.data("play") + '" class="sb-navigation-play"><i class="sb-icon-play sb-playbutton"></i><i class="sb-icon-pause sb-pausebutton"></i></a>');
                l(i, g);
                if (n.autoPlay != "on") {
